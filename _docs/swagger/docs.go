    ...
    "paths": {
        ...
        "/courses/{course_id}/rate": {
            "post": {
                ...
                "description": "Add rating to a course form 1 to 5 grate\nPrerequisites: User must be authenticated and must learn the course\nCourse must exist",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/course.addRateRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid course ID or body",
                        "schema": {
                            "$ref": "#/definitions/httputils.ErrorStruct"
                        }
                    },
                    ...
                    "403": {
                        "description": "User is not the 'student' of the course",
                        "schema": {
                            "$ref": "#/definitions/httputils.ErrorStruct"
                        }
                    },
        ...
        "/lessons/{lesson_id}/finish": {
            "put": {
                ...
                "description": "Mark lesson as completed and advance user progress in the course\nPrerequisites: User must be authenticated. User must have access to the lesson and not skipping lessons",
                "produces": [
                    "application/json"
                ],
                "tags": [
